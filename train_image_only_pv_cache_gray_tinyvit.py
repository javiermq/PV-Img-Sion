...
MODEL_OUT = "best_image_only_tinyvit_cache_gray_no_autoreg.pt"
PREDICTIONS_OUT = "eval_predictions_image_only_tinyvit_cache_gray_no_autoreg.tsv"
PLOT_OUT = "eval_timeline_image_only_tinyvit_cache_gray_no_autoreg.png"
...
CV_SUMMARY_OUT = "cv5_temporal_scene_metrics_image_only_tinyvit_cache_gray_no_autoreg.tsv"
CV_ALL_PREDICTIONS_OUT = "cv5_temporal_all_predictions_image_only_tinyvit_cache_gray_no_autoreg.tsv"
CV_PRODUCTION_SCENE_METRICS_OUT = "cv5_production_scene_metrics_image_only_tinyvit_cache_gray_no_autoreg.tsv"
...
class TinySequenceViTEncoder(nn.Module):
    ...
    def forward(self, imgs):
        # imgs: [B, T, 1, H, W]. Se apila la secuencia como canales: [B, T, H, W].
        b, t, c, h, w = imgs.shape

        if c != 1:
            raise RuntimeError(f"Este TinyViT espera imagenes de 1 canal, recibio C={c}.")
            ...
            torch.save(
                {
                    ...
                    "model_type": "image_only_tinyvit_cache_gray_no_autoreg_cv5_temporal",
                    "fold_id": fold_id,
                    "n_folds": N_FOLDS,
...
def main():
    ...
    print("Modo: SOLO imágenes cacheadas 1 canal gray + TinyViT por bloque [B,T,H,W]")
