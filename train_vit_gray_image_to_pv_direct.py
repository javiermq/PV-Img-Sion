...
MODEL_OUT = "best_vit_gray_image_to_pv_direct.pt"
PREDICTIONS_OUT = "eval_predictions_vit_gray_image_to_pv_direct.tsv"
PLOT_OUT = "eval_timeline_vit_gray_image_to_pv_direct.png"
...
CV_SUMMARY_OUT = "cv5_temporal_scene_metrics_vit_gray_image_to_pv_direct.tsv"
CV_ALL_PREDICTIONS_OUT = "cv5_temporal_all_predictions_vit_gray_image_to_pv_direct.tsv"
CV_PRODUCTION_SCENE_METRICS_OUT = "cv5_production_scene_metrics_vit_gray_image_to_pv_direct.tsv"
            ...
            torch.save(
                {
                    ...
                    "model_type": "vit_gray_image_to_pv_direct_cv5_temporal",
                    "fold_id": fold_id,
                    "n_folds": N_FOLDS,
...
def main():
    ...
    print("Modo: ViT gray directo imagen -> production")
