...
MODEL_OUT = "best_image_irradiation_to_lstm_pv_single_stage_gray.pt"
PREDICTIONS_OUT = "eval_predictions_image_irradiation_to_lstm_pv_single_stage_gray.tsv"
PLOT_OUT = "eval_timeline_image_irradiation_to_lstm_pv_single_stage_gray.png"

CV_SUMMARY_OUT = "cv5_temporal_scene_metrics_image_irradiation_to_lstm_pv_single_stage_gray.tsv"
CV_ALL_PREDICTIONS_OUT = "cv5_temporal_all_predictions_image_irradiation_to_lstm_pv_single_stage_gray.tsv"
CV_PRODUCTION_SCENE_METRICS_OUT = "cv5_production_scene_metrics_image_irradiation_to_lstm_pv_single_stage_gray.tsv"
...
class GentleImageSequenceEncoder(nn.Module):
    def __init__(
        self,
        lstm_hidden=128,
        lstm_layers=2,
...
class ImageIrradiationToPVSingleStageModel(nn.Module):
    def __init__(self):
        ...
        self.img_encoder = GentleImageSequenceEncoder(
            lstm_hidden=128,
            lstm_layers=2,
            lstm_dropout=0.2,
        )
            ...
            torch.save(
                {
                    ...
                    "model_type": "image_irradiation_to_lstm_pv_single_stage_gray_cv5_temporal",
                    "fold_id": fold_id,
                    "n_folds": N_FOLDS,
...
def main():
    ...
    print("Modo: imágenes gray -> irradiation auxiliar -> LSTM predicted-irradiation -> production")
